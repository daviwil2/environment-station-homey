...
module.exports = class EnvironmentStationDevice extends Homey.Device {
  ...
  onInit(){
    ...
    if (writeLogs){ this.log('connecting to MQTT server at mqtt://'+settings.server+':'+settings.port) };
    ...
    client.on('connect', function(){
      ...
      if (writeLogs){ this.log('connected to MQTT server, now subscribing to '+topics.length+message) };
    ...
    client.on('message', function(topic, message, packet){
      ...
      if (capability && capabilities.includes(capability)){
        ...
        if (writeLogs){ this.log('message received: '+capability+' value '+message) };
